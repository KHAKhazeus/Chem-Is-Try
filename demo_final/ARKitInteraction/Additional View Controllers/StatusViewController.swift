...
class StatusViewController: UIViewController {
    ...
    @IBOutlet weak private var changeExperienceButton: UIButton!

    // MARK: - Properties
    
    /// Trigerred when the "Restart Experience" button is tapped.
    var restartExperienceHandler: () -> Void = {}
    var changeExperienceHandler: () -> Void = {}
    ...
    @IBAction private func changeExperience(_ sender: UIButton){
        changeExperienceHandler()
    }
